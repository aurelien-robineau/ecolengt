...
export interface LegalNoticePage {
  ...
  /**
   * Rédigez le texte des mentions légales et de la politique de confidentialité.
   */
  content: {
    root: {
      type: string;
...
export interface SiteSetting {
   ...
   */
  addressMapLatitude?: number | null;
  addressMapLongitude?: number | null;
  /**
   ...
   * Coordonnées pour la carte OpenStreetMap : sur openstreetmap.org, clic droit sur le lieu → « Afficher l’adresse » (ex. 43.5266 et 5.4474 pour Aix-en-Provence).
   */
  intensiveCoursesAddressMapLatitude?: number | null;
  intensiveCoursesAddressMapLongitude?: number | null;
  /**
...
export interface SiteSettingsSelect<T extends boolean = true> {
  ...
  addressCity?: T;
  addressMapsUrl?: T;
  addressMapLatitude?: T;
  addressMapLongitude?: T;
  ...
  intensiveCoursesAddressMapLatitude?: T;
  intensiveCoursesAddressMapLongitude?: T;
